...
class AntColonySequencer:
    ...
    def construct_solution(self):
        ...
        while current_length < self.target_length:
            ...
            if not candidates:
                # Brak pasujących oligo — mrówka kończy
                break
            ...
            # Losujemy oligo (roulette wheel selection)
            r = random.random()
            cumulative = 0.0
            selected_oligo = None
            ...
            current_seq += selected_oligo[-1] # dodajemy jeden nowy znak
            # self.spectrum.remove(selected_oligo)
            usedOligos += 2
            current_length += 1
